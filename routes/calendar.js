...
exports.query = function(req,res) {
    ...
    else
    {
        ...
        ret.error       = null;
        ret.issort      = true;      
        calendardao.QueryCalendar(qstart,qend,req.ip,zonediff,function(dbdata){
           ret.events = [];
...
exports.save = function(req,res){
  ...
  {
    data.Id= newGuId();
    calendardao.addCalendar(data, function(){          
          ret.IsSuccess = true;
          ret.Msg       = __("successmsg");  
          ret.Data      = data.Id         
          res.json(ret);
...
exports.update =function(req,res){
    ...
    calendardao.UpdateCalendar(id,req.ip,data,function(){      
        ret.IsSuccess = true;
        ret.Msg       = __("successmsg");      
        res.json(ret);
    },function(err) {
...
exports.delete =function(req,res){
    ...
    calendardao.DeleteCalendar(id,req.ip,function(){       
        ret.IsSuccess = true;
        ret.Msg       = __("successmsg");        
        res.json(ret);
    },function(err) {
